...
import { updateUserById, getUserById } from '../../store/usersSlice';
...
const UserEdit = () => {
    ...
    useEffect(() => {
        ...
        dispatch(setPageInfo({ pageName: 'User', moduleName: 'User List', moduleLink: 'users', submoduleName: 'Edit User Information' }));
    }, [dispatch, id]);
    ...
    const handleSubmit = async (values, { setSubmitting, setErrors }) => {
        ...
        try {
            await dispatch(updateUserById(userData)).unwrap();
            dispatch(setToast({ type: 'success', message: 'User updated successfully!' }));
